...
It is build upon the well designed cower and expac backends.
...
pacaur honors a config file at I</etc/pacaur.conf>
...
Define the pacman binary. Default is B<pacman>.
...
Use color. It is recommended to use the pacman binary I<pacman-color> when
enabling this option. Default is B<true>.
