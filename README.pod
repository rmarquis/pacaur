...
Along the name of every package which belong to AUR there will be two numbers: votes and popularity, as you can find them on AUR website.
Packages flagged with <!> are packages out of date.
