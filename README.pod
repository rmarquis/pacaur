...
Enable silent output. This will send the output of each packaging functions to
text files in the build directory named I<pkgname-pkgver-pkgrel-arch-function.log>.
