...
Enable PKGBUILD and install script viewing prompt. Possible values are B<full>
...
Makepkg environment variables (I<$PACMAN>, I<$PKGDEST>, I<$SRCDEST>, I<LOGDEST>,
...
You might want to change the default build directory (set to /tmp on a temporary
