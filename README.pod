...
=item B<development build>

If you want to avoid cleaning up the build directory of development packages,
disable the I<cleandevel> config option. This will speed up the update even if
the I<clean> config option is enabled for normal packages.
...
B<[es] - Español> - Germán L. Osella "gosella" Massa E<lt>https://github.com/gosellaE<gt>
